...
The AppHost project is at:

```
~/Work/worktrees/LocalDevInfra/Hoffmann.LocalDev.AppHost/Hoffmann.LocalDev.AppHost.csproj
```

Pass `--apphost ~/Work/worktrees/LocalDevInfra/Hoffmann.LocalDev.AppHost/Hoffmann.LocalDev.AppHost.csproj` to any `aspire` command when not running from that directory.
