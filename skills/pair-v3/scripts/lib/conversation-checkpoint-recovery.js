...
const SYSTEM_INJECTED_BLOCK = /(?:<permissions instructions>|<environment_context>|<system-reminder>|<local-command|<command-name>|<user-prompt-submit-hook>|<task-notification>|^\s*\[Request interrupted)/iu;
