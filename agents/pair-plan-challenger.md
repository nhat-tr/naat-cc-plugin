...
- **missing or empty `## Implementation Context`** — the implementer runs as a sub-agent with no conversation history; if this section is absent, a placeholder, or lacks language/framework and key decisions, it is a BLOCKER
